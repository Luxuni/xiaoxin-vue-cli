...
<template>
  <div
    ...
    ">
    <div v-appearance="{ from: { y: 300, duration: 1 } }" class="flex flex-col items-center justify-center">
      <img src="/images/xiaoxin.png" class="object-cover w-40 h-40 mb-5 border-8 border-white rounded-full" />
      <div>
        <XiaoxinFormButton @click="$router.push({ name: 'dashboard' })" class="ml-2 danger"> 访问后台 </XiaoxinFormButton>
