...
<template>
  <div
    class="p-2 px-5 shadow-sm bg-xx-bgcolor relative overflow-auto h-[50px]"
    ...
    <div class="absolute flex gap-2 overflow-x-auto whitespace-pre">
      <n-tag
        ...
        <router-link class="inline-block w-full h-full duration-300 hover:text-[#AA77FF]" :to="{ name: route.name }">{{
          route.title
        }}</router-link>
      </n-tag>
    </div>
